                      ...
                      return  
                         Card(
                            ...
                            child: ClipRRect(
                              ...
                              child:InkWell(
                              onLongPress: (){
                                showDialog(context: context, builder: (BuildContext context)=> DeleteAlertDialog(category: snapshot.data!.docs[index].data(), collection: widget.kategoriya));
                              },
                              child:Column(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        BoxShadow(
                                          ...
                                          spreadRadius: 1,
                                          blurRadius: 1,
                                          offset: const Offset(0, 1), // changes x,y position of shadow
                                        ),
                                      ],
                                    ),
