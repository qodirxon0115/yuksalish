      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: "Address", hintStyle: TextStyle(color: Colors.grey[400]),
                border: InputBorder.none,
          ...
          Container(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: "Telefon raqami", hintStyle: TextStyle(color: Colors.grey[400]),
                border: InputBorder.none,
          ...
          Container(
            ...
            child: TextField(
              decoration: InputDecoration(
                  hintText: "Parolni qaytaring", hintStyle: TextStyle(color: Colors.grey[400]),
                  border: InputBorder.none,
                  icon: Icon(Icons.lock_open_outlined, color: Colors.grey[400],)
              ),
            ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                const Text("Hisobingiz bormi?", style: TextStyle(color: Colors.grey, fontSize: 16),),
                ...
                GestureDetector(
                  ...
                  child: const Text("Bu yerga o'ting!", style: TextStyle(color: Colors.blue, fontSize: 16,),),
                ),
              ],
            ),
          ),
